    ...
    <div>
      {loading ? (
        ...
        <>
          ...
          <p>Hotel name: <span style={{"text-transform": "capitalize"}}>{roomToDisplay.hotel.name}</span></p>
          <p>Room title: <span style={{"text-transform": "capitalize"}}>{roomToDisplay.title}</span></p>
